...
// 聚合测试广告位ID
#define gromore_reward_landscape_ID       @"103011517" //聚合激励视频广告位（BURewardedVideoAd && BUNativeExpressRewardedVideoAd）
#define gromore_splash_ID_2               @"103010582"
#define gromore_reward_ID                 @"103011517" //聚合激励视频广告位（BURewardedVideoAd && BUNativeExpressRewardedVideoAd）
#define gromore_splash_ID                 @"103010582" //聚合开屏广告位（BUSplashAd）
#define gromore_feed_ID                   @"103010783" //聚合feed广告位，用于测试模版 （BUNativeAdsManager）
#define gromore_feed_ID_2                 @"103010783" //聚合feed广告位2，用于测试自渲染 （BUNativeAdsManager）
#define gromore_draw_ID                   @"948423177" //聚合draw广告位，用于测试模版（BUNativeAdsManager）
#define gromore_draw_ID_2                 @"948423181" //聚合draw广告位2，用于测试自渲染（BUNativeAdsManager）
#define gromore_newInterstitial_ID        @"103010227" //聚合插全屏广告位（BUNativeExpressFullscreenVideoAd）
#define gromore_banner_ID                 @"103010581" //聚合banner广告位 （BUNativeExpressBannerView）
